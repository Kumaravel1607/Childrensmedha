...
class CourseSelect extends StatefulWidget {
  const CourseSelect({Key? key}) : super(key: key);
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            CourseCard(
              ...
              onTap: () {
                Navigator.of(context).pushAndRemoveUntil(
                    MaterialPageRoute(
                      builder: (BuildContext context) => CourseScreen(type: 1),
                    ),
            ...
            SizedBox(height: 20),
            CourseCard(
              title: 'Courses for Others',
              svgAsset: "assets/images/group.svg",
              onTap: () {
                Navigator.of(context).pushAndRemoveUntil(
                    MaterialPageRoute(
                      builder: (BuildContext context) => CourseScreen(type: 2),
                    ),
                    (Route<dynamic> route) => true);
                // Navigator.push(
                //   context,
